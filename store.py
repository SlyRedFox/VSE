...
def get_user_info_from_registry() -> dict:
    """
...
def get_network_info_from_interfaces() -> list:
    """
...
def get_os_info_from_registry() -> dict:
    """
...
def get_network_info() -> list:
    ...
    try:
        # Получение данных о сетевых адаптерах
        if platform.system() == 'Windows':
...
def get_bios_info_from_registry() -> dict:
    """
