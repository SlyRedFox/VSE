...
if a == 1:
    ...
    print('ВПИШИТЕ РЕЗУЛЬТАТ работы скрипта 4_rae.py для ã в переменную ниже ã_base (по умолчанию может быть равна 1) для дальнейших вычислений. (для примера 111x ≡ 75 (mod 321) будет -26 или 81, если приводим по модулю)')
    ã_base = 81
