...
print('\nЕсли результат отрицательное число, это тоже верный ответ. Но если мы хотим использовать его для дальнейших расчётов, то приводим его по модулю, чтобы сделать положительным. \nВ нашем случае:')
