...
# Расшифровка
def uncrypt_afina_recurr(n_mod_arg: int, alpha_list_arg: list, beta_list_arg: list) -> list:
...
if input_user == '1':
    ...
    # pass
    uncrypted_word: list = uncrypt_afina_recurr(n_mod, alpha_list, beta_list)
