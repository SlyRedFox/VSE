...
print(f'\nВычисляем ui по РАЕ, подробности на стр. 35 конспектов. \nИспользуем скрипт 4_rae.py Именно в нашем случае будет три итоговых таблицы.')
print('Для ui мы берём значение x2 из финальной строки таблицы. Результат для нашего примера: \nu1 = -4 \nu2 = 5 \nu3 = -1')


# TODO сделать через input ввод данных для бесшовного расчёта?
print('\nНУЖНО ВНЕСТИ значения ui и Ni - для нашего примера их три, при необходимости можно увеличить количество '
      'элементов ui и Ni - по-умолчанию значение ui может быть 1 Подробности на стр. 36')
# Нужно будет внести значения ui и Ni
u1: int = -4
u2: int = 5
u3: int = -1
...
print('\nПроверяем и выписываем все полученные ответы, подставляем их в исходные примеры задачи')
print('Т.е. 2323 ≡ 2 (mod 11) => 2323 mod 11 = 2 (детали в конспектах, страница 36)')
