...
x1: int = 57520216126176808443631405023338071176630104906313632182896741342206604859403
y1: int = 17614944419213781543809391949654080031942662045363639260709847859438286763994
...
print(f'Результат: число, которое делится нацело после прибавления к числителю модуля: {y_temp_elem_formula_one}')
...
# e: int = 20798893674476452017134061561508270130637142515379653289952617252661468872421
...
k: int = randint(0, q)
# k: int = 53854137677348463731403841147996619241504003434302020712960838528893196233395



print('\nШаг 4, Алгоритм формирования подписи')
print(f'Вычислить точку эллиптической кривой C = {k}P')
dot_p: tuple = (29700980915817952874371204983938256990422752107994319651632687982059210933395, 32842535278684663477094665322517084506804721032454543268132854556539274060910)
...
print(f's = {s}')
# s: int = 574973400270084654178925310019147038455227042649098563933718999175515839552
...
x3_result_formula_one: int = 29700980915817952874371204983938256990422752107994319651632687982059210933395
print('Также определяем R = x * c (mod q)')
print(f'C = {z1_check}P + {z2_check}Q')
